...
public class HelloworldController {
    ...
    @GetMapping(value = "/ipad/integer")
    public Integer getInteger() {
        return 10;
    }

    @GetMapping(value = "/ipad/integers")
    public Integer[] getIntegerArray() {
        return new Integer[] {1, 2, 3, 4, 5};
    }

    @GetMapping(value = "/ipad/strings")
    ...
    @GetMapping(value = "/ipad/cats")
    public List<Cat> getCats() {
        return Arrays.asList(new Cat("Ming", 2), new Cat("Wan", 3));
    }

    @GetMapping(value = "/ipad/datetime")
    public LocalDateTime getDatetime() {
        return LocalDateTime.now();
    }

    @GetMapping(value = "/ipad/shoppingmall")
