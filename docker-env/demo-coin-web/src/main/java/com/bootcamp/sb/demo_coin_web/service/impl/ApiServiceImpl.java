...
public class ApiServiceImpl implements ApiService {
  ...
  public List<CoinData> fetchCoinData() {
    // String url = "http://" + baseUrl + "/" + versionUrl + coinsMarketsEndpointUrl;
    String url =
        UriComponentsBuilder.fromUriString("http://" + baseUrl).pathSegment(versionUrl)
  ...
  public List<CoinOhlcData> fetchCoinOhlcData(String coinId) {
    ...
    // String url = "http://" + baseUrl + "/" + versionUrl + coinOhlcEndpointUrl
    // + "/" + coinId;
    String url =
        UriComponentsBuilder.fromUriString("http://" + baseUrl).pathSegment(versionUrl)
            .path(coinOhlcEndpointUrl + "/" + coinId).build().toUriString();
    System.out.println("*******************" + url);

    List<CoinOhlcData> coinOhlcDatas = Arrays
        .asList(this.restTemplate.getForObject(url, CoinOhlcData[].class));
